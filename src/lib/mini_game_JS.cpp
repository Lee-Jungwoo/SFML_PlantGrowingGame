...
//     // SFML 창 생성
//     RenderWindow window(VideoMode(720, 980), "water game");
...
//     if (!fireTex.loadFromFile("fire.png")) {
...
//     // 양동이 텍스처 로드
//     if (!bucketTex.loadFromFile("bucket.png")) {
